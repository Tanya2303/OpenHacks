                ...
                <div className="w-full md:w-1/2 py-20 px-5 md:px-10">
                  ...
                  <div>
                    <div className="grid place-items-center">
                      <button className="bg-[#333] text-white px-4 py-2 rounded-md mt-36 flex flex-1 space-x-2 space-y-2"
                        onClick={handleGithubLogin}>
                        <div className='w-4 h-4 pt-1 mx-1'>
                          <img src={GitHubLogo} width="120" height="120" />
                        </div>
                        Sign In With Github
                      </button>
                    </div>
